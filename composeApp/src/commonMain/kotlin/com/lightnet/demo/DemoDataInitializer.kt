            ...
            SceneLayer(
                ...
                sequence  = listOf(
                    SceneStep(runner = RunnerType.WAVE,
                        ...
                        waveWidth = 3, density = 128, duration = 4000),
                    SceneStep(runner = RunnerType.WAVE,
                        directionality = "geometric", angle = 135,
                        color = ColorRef.PalettePosition(40),
                        waveWidth = 2, density = 100, reverse = true, duration = 3000),
        ...
        layers = listOf(
            ...
            SceneLayer(
                ...
                sequence = listOf(
                    SceneStep(runner = RunnerType.WAVE,
                        color = ColorRef.PalettePosition(150),
                        waveWidth = 3, density = 40, duration = 12000),
                    SceneStep(runner = RunnerType.WAVE,
                        color = ColorRef.PalettePosition(180),
                        waveWidth = 2, density = 60, duration = 6000),
                ),
            ),
            ...
            SceneLayer(
                ...
                sequence   = listOf(
                    SceneStep(runner = RunnerType.WAVE,
                        ...
                        color = ColorRef.PalettePosition(200),
                        waveWidth = 2, density = 80, duration = 4000),
